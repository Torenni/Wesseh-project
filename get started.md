...
### <span style="color: red;">1. Fork this project</span>
...
### <span style="color: blue;">2. Rename the repository to `YOURUSERNAME.github.io`</span>
...
### <span style="color: green;">3. Customize your website settings</span>

<div style="text-decoration: underline;" markdown="1">
...
If you named your project correctly and made an edit to the config file, your website should be ready at `https://YOURUSERNAME.github.io`. Every time you make a change to any file, your website will get rebuilt and should be updated shortly. Your website will be initialized with several sample blog posts and a couple other pages.
